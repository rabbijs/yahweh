...
if(o.text=e,t)for(n in Ee)(i=t[n]||t.getAttribute&&t.getAttribute(n))&&o.setAttribute(n,i)
...
return xe.each(e.match(Ne)||[],function(e,r){t[r]=!0}),t}function l(e){return e}function c(e){throw e}function p(e,t,r,n){var i
try{e&&_e(i=e.promise)?i.call(e).done(t).fail(r):e&&_e(i=e.then)?i.call(e,t,r):t.apply(void 0,[e].slice(n))}catch(e){r.apply(void 0,[e])}}function h(){ue.removeEventListener("DOMContentLoaded",h),e.removeEventListener("load",h),xe.ready()}function d(e,t){return t.toUpperCase()}function f(e){return e.replace(Le,"ms-").replace(ze,d)}function m(){this.expando=xe.expando+m.uid++}function y(e){return"true"===e||"false"!==e&&("null"===e?null:e===+e+""?+e:Be.test(e)?JSON.parse(e):e)}function g(e,t,r){var n
...
return r}function v(e,t,r,n){var i,o,a=20,s=n?function(){return n.cur()}:function(){return xe.css(e,t,"")},u=s(),l=r&&r[3]||(xe.cssNumber[t]?"":"px"),c=e.nodeType&&(xe.cssNumber[t]||"px"!==l&&+u)&&Ke.exec(xe.css(e,t))
...
return i||(t=r.body.appendChild(r.createElement(n)),i=xe.css(t,"display"),t.parentNode.removeChild(t),"none"===i&&(i="block"),Ze[n]=i,i)}function _(e,t){for(var r,n,i=[],o=0,a=e.length;o<a;o++)n=e[o],n.style&&(r=n.style.display,t?("none"===r&&(i[o]=Ue.get(n,"display")||null,i[o]||(n.style.display="")),""===n.style.display&&Je(n)&&(i[o]=b(n))):"none"!==r&&(i[o]="none",Ue.set(n,"display",r)))
for(o=0;o<a;o++)null!=i[o]&&(e[o].style.display=i[o])
return e}function w(e,t){var r
return r=void 0!==e.getElementsByTagName?e.getElementsByTagName(t||"*"):void 0!==e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&o(e,t)?xe.merge([e],r):r}function E(e,t){for(var r=0,n=e.length;r<n;r++)Ue.set(e[r],"globalEval",!t||Ue.get(t[r],"globalEval"))}function x(e,t,r,i,o){for(var a,s,u,l,c,p,h=t.createDocumentFragment(),d=[],f=0,m=e.length;f<m;f++)if((a=e[f])||0===a)if("object"===n(a))xe.merge(d,a.nodeType?[a]:a)
else if(it.test(a)){for(s=s||h.appendChild(t.createElement("div")),u=(tt.exec(a)||["",""])[1].toLowerCase(),l=nt[u]||nt._default,s.innerHTML=l[1]+xe.htmlPrefilter(a)+l[2],p=l[0];p--;)s=s.lastChild
xe.merge(d,s.childNodes),s=h.firstChild,s.textContent=""}else d.push(t.createTextNode(a))
for(h.textContent="",f=0;a=d[f++];)if(i&&xe.inArray(a,i)>-1)o&&o.push(a)
else if(c=Qe(a),s=w(h.appendChild(a),"script"),c&&E(s),r)for(p=0;a=s[p++];)rt.test(a.type||"")&&r.push(a)
return h}function R(){return!0}function O(){return!1}function A(e,t){return e===C()==("focus"===t)}function C(){try{return ue.activeElement}catch(e){}}function S(e,t,r,n,i,o){var a,s
...
return 1===o&&(a=i,i=function(e){return xe().off(e),a.apply(this,arguments)},i.guid=a.guid||(a.guid=xe.guid++)),e.each(function(){xe.event.add(this,t,i,n,r)})}function T(e,t,r){if(!r)return void(void 0===Ue.get(e,t)&&xe.event.add(e,t,R))
Ue.set(e,t,!1),xe.event.add(e,t,{namespace:!1,handler:function(e){var n,i,o=Ue.get(this,t)
if(1&e.isTrigger&&this[t]){if(o.length)(xe.event.special[t]||{}).delegateType&&e.stopPropagation()
else if(o=ce.call(arguments),Ue.set(this,t,o),n=r(this,t),this[t](),i=Ue.get(this,t),o!==i||n?Ue.set(this,t,!1):i={},o!==i)return e.stopImmediatePropagation(),e.preventDefault(),i.value}else o.length&&(Ue.set(this,t,{value:xe.event.trigger(xe.extend(o[0],xe.Event.prototype),o.slice(1),this)}),e.stopImmediatePropagation())}})}function k(e,t){return o(e,"table")&&o(11!==t.nodeType?t:t.firstChild,"tr")?xe(e).children("tbody")[0]||e:e}function P(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function j(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function M(e,t){var r,n,i,o,a,s,u,l
if(1===t.nodeType){if(Ue.hasData(e)&&(o=Ue.access(e),a=Ue.set(t,o),l=o.events)){delete a.handle,a.events={}
for(i in l)for(r=0,n=l[i].length;r<n;r++)xe.event.add(t,i,l[i][r])}He.hasData(e)&&(s=He.access(e),u=xe.extend({},s),He.set(t,u))}}function N(e,t){var r=t.nodeName.toLowerCase()
...
var o,a,s,u,l,c,p=0,h=e.length,d=h-1,f=t[0],m=_e(f)
if(m||h>1&&"string"==typeof f&&!be.checkClone&&ct.test(f))return e.each(function(r){var o=e.eq(r)
m&&(t[0]=f.call(this,r,o.html())),D(o,t,n,i)})
if(h&&(o=x(t,e[0].ownerDocument,!1,e,i),a=o.firstChild,1===o.childNodes.length&&(o=a),a||i)){for(s=xe.map(w(o,"script"),P),u=s.length;p<h;p++)l=o,p!==d&&(l=xe.clone(l,!0,!0),u&&xe.merge(s,w(l,"script"))),n.call(e[p],l,p)
if(u)for(c=s[s.length-1].ownerDocument,xe.map(s,j),p=0;p<u;p++)l=s[p],rt.test(l.type||"")&&!Ue.access(l,"globalEval")&&xe.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?xe._evalUrl&&!l.noModule&&xe._evalUrl(l.src,{nonce:l.nonce||l.getAttribute("nonce")}):r(l.textContent.replace(pt,""),l,c))}return e}function I(e,t,r){for(var n,i=t?xe.filter(t,e):e,o=0;null!=(n=i[o]);o++)r||1!==n.nodeType||xe.cleanData(w(n)),n.parentNode&&(r&&Qe(n)&&E(w(n,"script")),n.parentNode.removeChild(n))
return e}function F(e,t,r){var n,i,o,a,s=e.style
return r=r||dt(e),r&&(a=r.getPropertyValue(t)||r[t],""!==a||Qe(e)||(a=xe.style(e,t)),!be.pixelBoxStyles()&&ht.test(a)&&ft.test(t)&&(n=s.width,i=s.minWidth,o=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=r.width,s.width=n,s.minWidth=i,s.maxWidth=o)),void 0!==a?a+"":a}function L(e,t){return{get:function(){return e()?void delete this.get:(this.get=t).apply(this,arguments)}}}function z(e){for(var t=e[0].toUpperCase()+e.slice(1),r=mt.length;r--;)if((e=mt[r]+t)in yt)return e}function q(e){var t=xe.cssProps[e]||gt[e]
return t||(e in yt?e:gt[e]=z(e)||e)}function U(e,t,r){var n=Ke.exec(t)
...
return!n&&o>=0&&(u+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-o-u-s-.5))||0),u}function B(e,t,r){var n=dt(e),i=!be.boxSizingReliable()||r,o=i&&"border-box"===xe.css(e,"boxSizing",!1,n),a=o,s=F(e,t,n),u="offset"+t[0].toUpperCase()+t.slice(1)
if(ht.test(s)){if(!r)return s
s="auto"}return(!be.boxSizingReliable()&&o||"auto"===s||!parseFloat(s)&&"inline"===xe.css(e,"display",!1,n))&&e.getClientRects().length&&(o="border-box"===xe.css(e,"boxSizing",!1,n),(a=u in e)&&(s=e[u])),(s=parseFloat(s)||0)+H(e,t,r||(o?"border":"content"),a,n,s)+"px"}function V(e,t,r,n,i){return new V.prototype.init(e,t,r,n,i)}function W(){xt&&(!1===ue.hidden&&e.requestAnimationFrame?e.requestAnimationFrame(W):e.setTimeout(W,xe.fx.interval),xe.fx.tick())}function K(){return e.setTimeout(function(){Et=void 0}),Et=Date.now()}function $(e,t){var r,n=0,i={height:e}
for(t=t?1:0;n<4;n+=2-t)r=$e[n],i["margin"+r]=i["padding"+r]=e
return t&&(i.opacity=i.width=e),i}function G(e,t,r){for(var n,i=(J.tweeners[t]||[]).concat(J.tweeners["*"]),o=0,a=i.length;o<a;o++)if(n=i[o].call(r,t,e))return n}function Q(e,t,r){var n,i,o,a,s,u,l,c,p="width"in t||"height"in t,h=this,d={},f=e.style,m=e.nodeType&&Je(e),y=Ue.get(e,"fxshow")
r.queue||(a=xe._queueHooks(e,"fx"),null==a.unqueued&&(a.unqueued=0,s=a.empty.fire,a.empty.fire=function(){a.unqueued||s()}),a.unqueued++,h.always(function(){h.always(function(){a.unqueued--,xe.queue(e,"fx").length||a.empty.fire()})}))
for(n in t)if(i=t[n],Rt.test(i)){if(delete t[n],o=o||"toggle"===i,i===(m?"hide":"show")){if("show"!==i||!y||void 0===y[n])continue
m=!0}d[n]=y&&y[n]||xe.style(e,n)}if((u=!xe.isEmptyObject(t))||!xe.isEmptyObject(d)){p&&1===e.nodeType&&(r.overflow=[f.overflow,f.overflowX,f.overflowY],l=y&&y.display,null==l&&(l=Ue.get(e,"display")),c=xe.css(e,"display"),"none"===c&&(l?c=l:(_([e],!0),l=e.style.display||l,c=xe.css(e,"display"),_([e]))),("inline"===c||"inline-block"===c&&null!=l)&&"none"===xe.css(e,"float")&&(u||(h.done(function(){f.display=l}),null==l&&(c=f.display,l="none"===c?"":c)),f.display="inline-block")),r.overflow&&(f.overflow="hidden",h.always(function(){f.overflow=r.overflow[0],f.overflowX=r.overflow[1],f.overflowY=r.overflow[2]})),u=!1
for(n in d)u||(y?"hidden"in y&&(m=y.hidden):y=Ue.access(e,"fxshow",{display:l}),o&&(y.hidden=!m),m&&_([e],!0),h.done(function(){m||_([e]),Ue.remove(e,"fxshow")
for(n in d)xe.style(e,n,d[n])})),u=G(m?y[n]:0,n,h),n in y||(y[n]=u.start,m&&(u.end=u.start,u.start=0))}}function Y(e,t){var r,n,i,o,a
...
for(var t=Et||K(),r=Math.max(0,l.startTime+l.duration-t),n=r/l.duration||0,o=1-n,a=0,u=l.tweens.length;a<u;a++)l.tweens[a].run(o)
return s.notifyWith(e,[l,o,r]),o<1&&u?r:(u||s.notifyWith(e,[l,1,0]),s.resolveWith(e,[l]),!1)},l=s.promise({elem:e,props:xe.extend({},t),opts:xe.extend(!0,{specialEasing:{},easing:xe.easing._default},r),originalProperties:t,originalOptions:r,startTime:Et||K(),duration:r.duration,tweens:[],createTween:function(t,r){var n=xe.Tween(e,l.opts,t,r,l.opts.specialEasing[t]||l.opts.easing)
...
return xe.map(c,G,l),_e(l.opts.start)&&l.opts.start.call(e,l),l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always),xe.fx.timer(xe.extend(u,{elem:e,anim:l,queue:l.opts.queue})),l}function X(e){return(e.match(Ne)||[]).join(" ")}function Z(e){return e.getAttribute&&e.getAttribute("class")||""}function ee(e){return Array.isArray(e)?e:"string"==typeof e?e.match(Ne)||[]:[]}function te(e,t,r,i){var o
...
else try{t=a(t)}catch(e){return{state:"parsererror",error:a?e:"No conversion from "+u+" to "+o}}}return{state:"success",data:t}}var se=[],ue=e.document,le=Object.getPrototypeOf,ce=se.slice,pe=se.concat,he=se.push,de=se.indexOf,fe={},me=fe.toString,ye=fe.hasOwnProperty,ge=ye.toString,ve=ge.call(Object),be={},_e=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},we=function(e){return null!=e&&e===e.window},Ee={type:!0,src:!0,nonce:!0,noModule:!0},xe=function(e,t){return new xe.fn.init(e,t)},Re=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g
...
return this.pushStack(r>=0&&r<t?[this[r]]:[])},end:function(){return this.prevObject||this.constructor()},push:he,sort:se.sort,splice:se.splice},xe.extend=xe.fn.extend=function(){var e,t,r,n,i,o,a=arguments[0]||{},s=1,u=arguments.length,l=!1
...
return!(!e||"[object Object]"!==me.call(e))&&(!(t=le(e))||"function"==typeof(r=ye.call(t,"constructor")&&t.constructor)&&ge.call(r)===ve)},isEmptyObject:function(e){var t
for(t in e)return!1
...
return null!=e&&(i(Object(e))?xe.merge(r,"string"==typeof e?[e]:e):he.call(r,e)),r},inArray:function(e,t,r){return null==t?-1:de.call(t,e,r)},merge:function(e,t){for(var r=+t.length,n=0,i=e.length;n<r;n++)e[i++]=t[n]
...
var Oe=function(e){function t(e,t,r,n){var i,o,a,s,u,c,h,d=t&&t.ownerDocument,f=t?t.nodeType:9
if(r=r||[],"string"!=typeof e||!e||1!==f&&9!==f&&11!==f)return r
if(!n&&((t?t.ownerDocument||t:z)!==P&&k(t),t=t||P,M)){if(11!==f&&(u=ge.exec(e)))if(i=u[1]){if(9===f){if(!(a=t.getElementById(i)))return r
...
if((i=u[3])&&_.getElementsByClassName&&t.getElementsByClassName)return J.apply(r,t.getElementsByClassName(i)),r}if(_.qsa&&!W[e+" "]&&(!N||!N.test(e))&&(1!==f||"object"!==t.nodeName.toLowerCase())){if(h=e,d=t,1===f&&le.test(e)){for((s=t.getAttribute("id"))?s=s.replace(we,Ee):t.setAttribute("id",s=L),c=R(e),o=c.length;o--;)c[o]="#"+s+" "+p(c[o])
h=c.join(","),d=ve.test(e)&&l(t.parentNode)||t}try{return J.apply(r,d.querySelectorAll(h)),r}catch(t){W(e,!0)}finally{s===L&&t.removeAttribute("id")}}}return A(e.replace(ae,"$1"),t,r,n)}function r(){function e(r,n){return t.push(r+" ")>w.cacheLength&&delete e[t.shift()],e[r+" "]=n}var t=[]
...
o(null,b=[],l,u)}for(c=b.length;c--;)(p=b[c])&&(l=o?Z(n,p):h[c])>-1&&(n[l]=!(a[l]=p))}}else b=m(b===a?b.splice(y,b.length):b),o?o(null,a,b,u):J.apply(a,b)})}function g(e){for(var t,r,n,i=e.length,o=w.relative[e[0].type],a=o||w.relative[" "],s=o?1:0,u=h(function(e){return e===t},a,!0),l=h(function(e){return Z(t,e)>-1},a,!0),c=[function(e,r,n){var i=!o&&(n||r!==C)||((t=r).nodeType?u(e,r,n):l(e,r,n))
return t=null,i}];s<i;s++)if(r=w.relative[e[s].type])c=[h(d(c),r)]
else{if(r=w.filter[e[s].type].apply(null,e[s].matches),r[L]){for(n=++s;n<i&&!w.relative[e[n].type];n++);return y(s>1&&d(c),s>1&&p(e.slice(0,s-1).concat({value:" "===e[s-2].type?"*":""})).replace(ae,"$1"),r,s<n&&g(e.slice(s,n)),n<i&&g(e=e.slice(n)),n<i&&p(e))}c.push(r)}return d(c)}function v(e,r){var i=r.length>0,o=e.length>0,a=function(n,a,s,u,l){var c,p,h,d=0,f="0",y=n&&[],g=[],v=C,b=n||o&&w.find.TAG("*",l),_=q+=null==v?1:Math.random()||.1,E=b.length
for(l&&(C=a===P||a||l);f!==E&&null!=(c=b[f]);f++){if(o&&c){for(p=0,a||c.ownerDocument===P||(k(c),s=!M);h=e[p++];)if(h(c,a||P,s)){u.push(c)
break}l&&(q=_)}i&&((c=!h&&c)&&d--,n&&y.push(c))}if(d+=f,i&&f!==d){for(p=0;h=r[p++];)h(y,g,a,s)
if(n){if(d>0)for(;f--;)y[f]||g[f]||(g[f]=Q.call(u))
g=m(g)}J.apply(u,g),l&&!n&&g.length>0&&d+r.length>1&&t.uniqueSort(u)}return l&&(q=_,C=v),y}
return i?n(a):a}var b,_,w,E,x,R,O,A,C,S,T,k,P,j,M,N,D,I,F,L="sizzle"+1*new Date,z=e.document,q=0,U=0,H=r(),B=r(),V=r(),W=r(),K=function(e,t){return e===t&&(T=!0),0},$={}.hasOwnProperty,G=[],Q=G.pop,Y=G.push,J=G.push,X=G.slice,Z=function(e,t){for(var r=0,n=e.length;r<n;r++)if(e[r]===t)return r
return-1},ee="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",te="[\\x20\\t\\r\\n\\f]",re="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",ne="\\["+te+"*("+re+")(?:"+te+"*([*^$|!~]?=)"+te+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+re+"))|)"+te+"*\\]",ie=":("+re+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+ne+")*)|.*)\\)|)",oe=new RegExp(te+"+","g"),ae=new RegExp("^"+te+"+|((?:^|[^\\\\])(?:\\\\.)*)"+te+"+$","g"),se=new RegExp("^"+te+"*,"+te+"*"),ue=new RegExp("^"+te+"*([>+~]|"+te+")"+te+"*"),le=new RegExp(te+"|>"),ce=new RegExp(ie),pe=new RegExp("^"+re+"$"),he={ID:new RegExp("^#("+re+")"),CLASS:new RegExp("^\\.("+re+")"),TAG:new RegExp("^("+re+"|[*])"),ATTR:new RegExp("^"+ne),PSEUDO:new RegExp("^"+ie),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+te+"*(even|odd|(([+-]|)(\\d*)n|)"+te+"*(?:([+-]|)"+te+"*(\\d+)|))"+te+"*\\)|)","i"),bool:new RegExp("^(?:"+ee+")$","i"),needsContext:new RegExp("^"+te+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+te+"*((?:-\\d)?\\d*)"+te+"*\\)|)(?=[^-]|$)","i")},de=/HTML$/i,fe=/^(?:input|select|textarea|button)$/i,me=/^h\d$/i,ye=/^[^{]+\{\s*\[native \w/,ge=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ve=/[+~]/,be=new RegExp("\\\\([\\da-f]{1,6}"+te+"?|("+te+")|.)","ig"),_e=function(e,t,r){var n="0x"+t-65536
return n!==n||r?t:n<0?String.fromCharCode(n+65536):String.fromCharCode(n>>10|55296,1023&n|56320)},we=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,Ee=function(e,t){return t?"\0"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e},xe=function(){k()},Re=h(function(e){return!0===e.disabled&&"fieldset"===e.nodeName.toLowerCase()},{dir:"parentNode",next:"legend"})
...
return!de.test(t||r&&r.nodeName||"HTML")},k=t.setDocument=function(e){var t,r,n=e?e.ownerDocument||e:z
return n!==P&&9===n.nodeType&&n.documentElement?(P=n,j=P.documentElement,M=!x(P),z!==P&&(r=P.defaultView)&&r.top!==r&&(r.addEventListener?r.addEventListener("unload",xe,!1):r.attachEvent&&r.attachEvent("onunload",xe)),_.attributes=i(function(e){return e.className="i",!e.getAttribute("className")}),_.getElementsByTagName=i(function(e){return e.appendChild(P.createComment("")),!e.getElementsByTagName("*").length}),_.getElementsByClassName=ye.test(P.getElementsByClassName),_.getById=i(function(e){return j.appendChild(e).id=L,!P.getElementsByName||!P.getElementsByName(L).length}),_.getById?(w.filter.ID=function(e){var t=e.replace(be,_e)
...
return r?[r]:[]}}):(w.filter.ID=function(e){var t=e.replace(be,_e)
...
for(;s[n]===u[n];)n++
return n?a(s[n],u[n]):s[n]===z?-1:u[n]===z?1:0},P):P},t.matches=function(e,r){return t(e,null,null,r)},t.matchesSelector=function(e,r){if((e.ownerDocument||e)!==P&&k(e),_.matchesSelector&&M&&!W[r+" "]&&(!D||!D.test(r))&&(!N||!N.test(r)))try{var n=I.call(e,r)
...
return void 0!==n?n:_.attributes||!M?e.getAttribute(t):(n=e.getAttributeNode(t))&&n.specified?n.value:null},t.escape=function(e){return(e+"").replace(we,Ee)},t.error=function(e){throw new Error("Syntax error, unrecognized expression: "+e)},t.uniqueSort=function(e){var t,r=[],n=0,i=0
...
return he.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":r&&ce.test(r)&&(t=R(r,!0))&&(t=r.indexOf(")",r.length-t)-r.length)&&(e[0]=e[0].slice(0,t),e[2]=r.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(be,_e).toLowerCase()
...
return o[L]?o(r):o.length>1?(i=[e,e,"",r],w.setFilters.hasOwnProperty(e.toLowerCase())?n(function(e,t){for(var n,i=o(e,r),a=i.length;a--;)n=Z(e,i[a]),e[n]=!(t[n]=i[a])}):function(e){return o(e,0,i)}):o}},pseudos:{not:n(function(e){var t=[],r=[],i=O(e.replace(ae,"$1"))
return i[L]?n(function(e,t,r,n){for(var o,a=i(e,null,n,[]),s=e.length;s--;)(o=a[s])&&(e[s]=!(t[s]=o))}):function(e,n,o){return t[0]=e,i(t,null,o,r),t[0]=null,!r.pop()}}),has:n(function(e){return function(r){return t(e,r).length>0}}),contains:n(function(e){return e=e.replace(be,_e),function(t){return(t.textContent||E(t)).indexOf(e)>-1}}),lang:n(function(e){return pe.test(e||"")||t.error("unsupported lang: "+e),e=e.replace(be,_e).toLowerCase(),function(t){var r
...
if(r=r||[],1===h.length){if(o=h[0]=h[0].slice(0),o.length>2&&"ID"===(a=o[0]).type&&9===t.nodeType&&M&&w.relative[o[1].type]){if(!(t=(w.find.ID(a.matches[0].replace(be,_e),t)||[])[0]))return r
c&&(t=t.parentNode),e=e.slice(o.shift().value.length)}for(i=he.needsContext.test(e)?0:o.length;i--&&(a=o[i],!w.relative[s=a.type]);)if((u=w.find[s])&&(n=u(a.matches[0].replace(be,_e),ve.test(o[0].type)&&l(t.parentNode)||t))){if(o.splice(i,1),!(e=n.length&&p(o)))return J.apply(r,n),r
...
xe.find=Oe,xe.expr=Oe.selectors,xe.expr[":"]=xe.expr.pseudos,xe.uniqueSort=xe.unique=Oe.uniqueSort,xe.text=Oe.getText,xe.isXMLDoc=Oe.isXML,xe.contains=Oe.contains,xe.escapeSelector=Oe.escape
...
var ke,Pe=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(xe.fn.init=function(e,t,r){var n,i
if(!e)return this
if(r=r||ke,"string"==typeof e){if(!(n="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:Pe.exec(e))||!n[1]&&t)return!t||t.jquery?(t||r).find(e):this.constructor(t).find(e)
...
return t&&11!==t.nodeType?t:null},parents:function(e){return Ae(e,"parentNode")},parentsUntil:function(e,t,r){return Ae(e,"parentNode",r)},next:function(e){return s(e,"nextSibling")},prev:function(e){return s(e,"previousSibling")},nextAll:function(e){return Ae(e,"nextSibling")},prevAll:function(e){return Ae(e,"previousSibling")},nextUntil:function(e,t,r){return Ae(e,"nextSibling",r)},prevUntil:function(e,t,r){return Ae(e,"previousSibling",r)},siblings:function(e){return Ce((e.parentNode||{}).firstChild,e)},children:function(e){return Ce(e.firstChild)},contents:function(e){return void 0!==e.contentDocument?e.contentDocument:(o(e,"template")&&(e=e.content||e),xe.merge([],e.childNodes))}},function(e,t){xe.fn[e]=function(r,n){var i=xe.map(this,t,r)
return"Until"!==e.slice(-5)&&(n=r),n&&"string"==typeof n&&(i=xe.filter(n,i)),this.length>1&&(Me[e]||xe.uniqueSort(i),je.test(e)&&i.reverse()),this.pushStack(i)}})
var Ne=/[^\x20\t\r\n\f]+/g
...
p=e&&("object"==typeof e||"function"==typeof e)&&e.then,_e(p)?i?p.call(e,o(a,r,l,i),o(a,r,c,i)):(a++,p.call(e,o(a,r,l,i),o(a,r,c,i),o(a,r,l,r.notifyWith))):(n!==l&&(s=void 0,u=[e]),(i||r.resolveWith)(s,u))}},h=i?p:function(){try{p()}catch(e){xe.Deferred.exceptionHook&&xe.Deferred.exceptionHook(e,h.stackTrace),t+1>=a&&(n!==c&&(s=void 0,u=[e]),r.rejectWith(s,u))}}
t?h():(xe.Deferred.getStackHook&&(h.stackTrace=xe.Deferred.getStackHook()),e.setTimeout(h))}}var a=0
...
var Ie=xe.Deferred()
xe.fn.ready=function(e){return Ie.then(e).catch(function(e){xe.readyException(e)}),this},xe.extend({isReady:!1,readyWait:1,ready:function(e){(!0===e?--xe.readyWait:xe.isReady)||(xe.isReady=!0,!0!==e&&--xe.readyWait>0||Ie.resolveWith(ue,[xe]))}}),xe.ready.then=Ie.then,"complete"===ue.readyState||"loading"!==ue.readyState&&!ue.documentElement.doScroll?e.setTimeout(xe.ready):(ue.addEventListener("DOMContentLoaded",h),e.addEventListener("load",h))
...
return o?e:c?t.call(e):l?t(e[0],r):a},Le=/^-ms-/,ze=/-([a-z])/g,qe=function(e){return 1===e.nodeType||9===e.nodeType||!+e.nodeType}
...
var Ue=new m,He=new m,Be=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Ve=/[A-Z]/g
xe.extend({hasData:function(e){return He.hasData(e)||Ue.hasData(e)},data:function(e,t,r){return He.access(e,t,r)},removeData:function(e,t){He.remove(e,t)},_data:function(e,t,r){return Ue.access(e,t,r)},_removeData:function(e,t){Ue.remove(e,t)}}),xe.fn.extend({data:function(e,t){var r,n,i,o=this[0],a=o&&o.attributes
if(void 0===e){if(this.length&&(i=He.get(o),1===o.nodeType&&!Ue.get(o,"hasDataAttrs"))){for(r=a.length;r--;)a[r]&&(n=a[r].name,0===n.indexOf("data-")&&(n=f(n.slice(5)),g(o,n,i[n])))
Ue.set(o,"hasDataAttrs",!0)}return i}return"object"==typeof e?this.each(function(){He.set(this,e)}):Fe(this,function(t){var r
if(o&&void 0===t){if(void 0!==(r=He.get(o,e)))return r
if(void 0!==(r=g(o,e)))return r}else this.each(function(){He.set(this,e,t)})},null,t,arguments.length>1,null,!0)},removeData:function(e){return this.each(function(){He.remove(this,e)})}}),xe.extend({queue:function(e,t,r){var n
if(e)return t=(t||"fx")+"queue",n=Ue.get(e,t),r&&(!n||Array.isArray(r)?n=Ue.access(e,t,xe.makeArray(r)):n.push(r)),n||[]},dequeue:function(e,t){t=t||"fx"
...
return Ue.get(e,r)||Ue.access(e,r,{empty:xe.Callbacks("once memory").add(function(){Ue.remove(e,[t+"queue",r])})})}}),xe.fn.extend({queue:function(e,t){var r=2
...
for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";a--;)(r=Ue.get(o[a],e+"queueHooks"))&&r.empty&&(n++,r.empty.add(s))
...
xe.event={global:{},add:function(e,t,r,n,i){var o,a,s,u,l,c,p,h,d,f,m,y=Ue.get(e)
if(y)for(r.handler&&(o=r,r=o.handler,i=o.selector),i&&xe.find.matchesSelector(Ge,i),r.guid||(r.guid=xe.guid++),(u=y.events)||(u=y.events={}),(a=y.handle)||(a=y.handle=function(t){return void 0!==xe&&xe.event.triggered!==t.type?xe.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(Ne)||[""],l=t.length;l--;)s=st.exec(t[l])||[],d=m=s[1],f=(s[2]||"").split(".").sort(),d&&(p=xe.event.special[d]||{},d=(i?p.delegateType:p.bindType)||d,p=xe.event.special[d]||{},c=xe.extend({type:d,origType:m,data:n,handler:r,guid:r.guid,selector:i,needsContext:i&&xe.expr.match.needsContext.test(i),namespace:f.join(".")},o),(h=u[d])||(h=u[d]=[],h.delegateCount=0,p.setup&&!1!==p.setup.call(e,n,f,a)||e.addEventListener&&e.addEventListener(d,a)),p.add&&(p.add.call(e,c),c.handler.guid||(c.handler.guid=r.guid)),i?h.splice(h.delegateCount++,0,c):h.push(c),xe.event.global[d]=!0)},remove:function(e,t,r,n,i){var o,a,s,u,l,c,p,h,d,f,m,y=Ue.hasData(e)&&Ue.get(e)
if(y&&(u=y.events)){for(t=(t||"").match(Ne)||[""],l=t.length;l--;)if(s=st.exec(t[l])||[],d=m=s[1],f=(s[2]||"").split(".").sort(),d){for(p=xe.event.special[d]||{},d=(n?p.delegateType:p.bindType)||d,h=u[d]||[],s=s[2]&&new RegExp("(^|\\.)"+f.join("\\.(?:.*\\.|)")+"(\\.|$)"),a=o=h.length;o--;)c=h[o],!i&&m!==c.origType||r&&r.guid!==c.guid||s&&!s.test(c.namespace)||n&&n!==c.selector&&("**"!==n||!c.selector)||(h.splice(o,1),c.selector&&h.delegateCount--,p.remove&&p.remove.call(e,c))
a&&!h.length&&(p.teardown&&!1!==p.teardown.call(e,f,y.handle)||xe.removeEvent(e,d,y.handle),delete u[d])}else for(d in u)xe.event.remove(e,d+t[l],r,n,!0)
xe.isEmptyObject(u)&&Ue.remove(e,"handle events")}},dispatch:function(e){var t,r,n,i,o,a,s=xe.event.fix(e),u=new Array(arguments.length),l=(Ue.get(this,"events")||{})[s.type]||[],c=xe.event.special[s.type]||{}
...
return et.test(t.type)&&t.click&&o(t,"input")&&T(t,"click",R),!1},trigger:function(e){var t=this||e
return et.test(t.type)&&t.click&&o(t,"input")&&T(t,"click"),!0},_default:function(e){var t=e.target
return et.test(t.type)&&t.click&&o(t,"input")&&Ue.get(t,"click")||o(t,"a")}},beforeunload:{postDispatch:function(e){void 0!==e.result&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}}},xe.removeEvent=function(e,t,r){e.removeEventListener&&e.removeEventListener(t,r)},xe.Event=function(e,t){if(!(this instanceof xe.Event))return new xe.Event(e,t)
e&&e.type?(this.originalEvent=e,this.type=e.type,this.isDefaultPrevented=e.defaultPrevented||void 0===e.defaultPrevented&&!1===e.returnValue?R:O,this.target=e.target&&3===e.target.nodeType?e.target.parentNode:e.target,this.currentTarget=e.currentTarget,this.relatedTarget=e.relatedTarget):this.type=e,t&&xe.extend(this,t),this.timeStamp=e&&e.timeStamp||Date.now(),this[xe.expando]=!0},xe.Event.prototype={constructor:xe.Event,isDefaultPrevented:O,isPropagationStopped:O,isImmediatePropagationStopped:O,isSimulated:!1,preventDefault:function(){var e=this.originalEvent
...
this.isImmediatePropagationStopped=R,e&&!this.isSimulated&&e.stopImmediatePropagation(),this.stopPropagation()}},xe.each({altKey:!0,bubbles:!0,cancelable:!0,changedTouches:!0,ctrlKey:!0,detail:!0,eventPhase:!0,metaKey:!0,pageX:!0,pageY:!0,shiftKey:!0,view:!0,char:!0,code:!0,charCode:!0,key:!0,keyCode:!0,button:!0,buttons:!0,clientX:!0,clientY:!0,offsetX:!0,offsetY:!0,pointerId:!0,pointerType:!0,screenX:!0,screenY:!0,targetTouches:!0,toElement:!0,touches:!0,which:function(e){var t=e.button
return null==e.which&&ot.test(e.type)?null!=e.charCode?e.charCode:e.keyCode:!e.which&&void 0!==t&&at.test(e.type)?1&t?1:2&t?3:4&t?2:0:e.which}},xe.event.addProp),xe.each({focus:"focusin",blur:"focusout"},function(e,t){xe.event.special[e]={setup:function(){return T(this,e,A),!1},trigger:function(){return T(this,e),!0},delegateType:t}}),xe.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,t){xe.event.special[e]={delegateType:t,bindType:t,handle:function(e){var r,n=this,i=e.relatedTarget,o=e.handleObj
...
return this}return!1!==t&&"function"!=typeof t||(r=t,t=void 0),!1===r&&(r=O),this.each(function(){xe.event.remove(this,e,r,t)})}})
...
try{for(;r<n;r++)t=this[r]||{},1===t.nodeType&&(xe.cleanData(w(t,!1)),t.innerHTML=e)
t=0}catch(e){}}t&&this.empty().append(e)},null,e,arguments.length)},replaceWith:function(){var e=[]
return D(this,arguments,function(t){var r=this.parentNode
xe.inArray(this,e)<0&&(xe.cleanData(w(this)),r&&r.replaceChild(t,this))},e)}}),xe.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){xe.fn[e]=function(e){for(var r,n=[],i=xe(e),o=i.length-1,a=0;a<=o;a++)r=a===o?this:this.clone(!0),xe(i[a])[t](r),he.apply(n,r.get())
return this.pushStack(n)}})
var ht=new RegExp("^("+We+")(?!px)[a-z%]+$","i"),dt=function(t){var r=t.ownerDocument.defaultView
...
var mt=["Webkit","Moz","ms"],yt=ue.createElement("div").style,gt={},vt=/^(none|table(?!-c[ea]).+)/,bt=/^--/,_t={position:"absolute",visibility:"hidden",display:"block"},wt={letterSpacing:"0",fontWeight:"400"}
...
if(u||(t=q(s)),a=xe.cssHooks[t]||xe.cssHooks[s],void 0===r)return a&&"get"in a&&void 0!==(i=a.get(e,!1,n))?i:l[t]
o=typeof r,"string"===o&&(i=Ke.exec(r))&&i[1]&&(r=v(e,t,i),o="number"),null!=r&&r===r&&("number"!==o||u||(r+=i&&i[3]||(xe.cssNumber[s]?"":"px")),be.clearCloneStyle||""!==r||0!==t.indexOf("background")||(l[t]="inherit"),a&&"set"in a&&void 0===(r=a.set(e,r,n))||(u?l.setProperty(t,r):l[t]=r))}},css:function(e,t,r,n){var i,o,a,s=f(t)
return bt.test(t)||(t=q(s)),a=xe.cssHooks[t]||xe.cssHooks[s],a&&"get"in a&&(i=a.get(e,!0,r)),void 0===i&&(i=F(e,t,n)),"normal"===i&&t in wt&&(i=wt[t]),""===r||r?(o=parseFloat(i),!0===r||isFinite(o)?o||0:i):i}}),xe.each(["height","width"],function(e,t){xe.cssHooks[t]={get:function(e,r,n){if(r)return!vt.test(xe.css(e,"display"))||e.getClientRects().length&&e.getBoundingClientRect().width?B(e,t,n):Xe(e,_t,function(){return B(e,t,n)})},set:function(e,r,n){var i,o=dt(e),a=!be.scrollboxSize()&&"absolute"===o.position,s=a||n,u=s&&"border-box"===xe.css(e,"boxSizing",!1,o),l=n?H(e,t,n,u,o):0
...
return i}},"margin"!==e&&(xe.cssHooks[e+t].set=U)}),xe.fn.extend({css:function(e,t){return Fe(this,function(e,t,r){var n,i,o={},a=0
if(Array.isArray(t)){for(n=dt(e),i=t.length;a<i;a++)o[t[a]]=xe.css(e,t[a],!1,n)
...
return 1!==e.elem.nodeType||null!=e.elem[e.prop]&&null==e.elem.style[e.prop]?e.elem[e.prop]:(t=xe.css(e.elem,e.prop,""),t&&"auto"!==t?t:0)},set:function(e){xe.fx.step[e.prop]?xe.fx.step[e.prop](e):1!==e.elem.nodeType||!xe.cssHooks[e.prop]&&null==e.elem.style[q(e.prop)]?e.elem[e.prop]=e.now:xe.style(e.elem,e.prop,e.now+e.unit)}}},V.propHooks.scrollTop=V.propHooks.scrollLeft={set:function(e){e.elem.nodeType&&e.elem.parentNode&&(e.elem[e.prop]=e.now)}},xe.easing={linear:function(e){return e},swing:function(e){return.5-Math.cos(e*Math.PI)/2},_default:"swing"},xe.fx=V.prototype.init,xe.fx.step={}
var Et,xt,Rt=/^(?:toggle|show|hide)$/,Ot=/queueHooks$/
xe.Animation=xe.extend(J,{tweeners:{"*":[function(e,t){var r=this.createTween(e,t)
return v(r.elem,e,Ke.exec(t),r),r}]},tweener:function(e,t){_e(e)?(t=e,e=["*"]):e=e.match(Ne)
...
r.length||xe.fx.stop(),Et=void 0},xe.fx.timer=function(e){xe.timers.push(e),xe.fx.start()},xe.fx.interval=13,xe.fx.start=function(){xt||(xt=!0,W())},xe.fx.stop=function(){xt=null},xe.fx.speeds={slow:600,fast:200,_default:400},xe.fn.delay=function(t,r){return t=xe.fx?xe.fx.speeds[t]||t:t,r=r||"fx",this.queue(r,function(r,n){var i=e.setTimeout(r,t)
...
if(3!==o&&8!==o&&2!==o)return void 0===e.getAttribute?xe.prop(e,t,r):(1===o&&xe.isXMLDoc(e)||(i=xe.attrHooks[t.toLowerCase()]||(xe.expr.match.bool.test(t)?At:void 0)),void 0!==r?null===r?void xe.removeAttr(e,t):i&&"set"in i&&void 0!==(n=i.set(e,r,t))?n:(e.setAttribute(t,r+""),r):i&&"get"in i&&null!==(n=i.get(e,t))?n:(n=xe.find.attr(e,t),null==n?void 0:n))},attrHooks:{type:{set:function(e,t){if(!be.radioValue&&"radio"===t&&o(e,"input")){var r=e.value
return e.setAttribute("type",t),r&&(e.value=r),t}}}},removeAttr:function(e,t){var r,n=0,i=t&&t.match(Ne)
if(i&&1===e.nodeType)for(;r=i[n++];)e.removeAttribute(r)}}),At={set:function(e,t,r){return!1===t?xe.removeAttr(e,r):e.setAttribute(r,r),r}},xe.each(xe.expr.match.bool.source.match(/\w+/g),function(e,t){var r=Ct[t]||xe.find.attr
...
else void 0!==e&&"boolean"!==r||(t=Z(this),t&&Ue.set(this,"__className__",t),this.setAttribute&&this.setAttribute("class",t||!1===e?"":Ue.get(this,"__className__")||""))})},hasClass:function(e){var t,r,n=0
...
var Pt=/^(?:focusinfocus|focusoutblur)$/,jt=function(e){e.stopPropagation()}
xe.extend(xe.event,{trigger:function(t,r,n,i){var o,a,s,u,l,c,p,h,d=[n||ue],f=ye.call(t,"type")?t.type:t,m=ye.call(t,"namespace")?t.namespace.split("."):[]
if(a=h=s=n=n||ue,3!==n.nodeType&&8!==n.nodeType&&!Pt.test(f+xe.event.triggered)&&(f.indexOf(".")>-1&&(m=f.split("."),f=m.shift(),m.sort()),l=f.indexOf(":")<0&&"on"+f,t=t[xe.expando]?t:new xe.Event(f,"object"==typeof t&&t),t.isTrigger=i?2:3,t.namespace=m.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=n),r=null==r?[t]:xe.makeArray(r,[t]),p=xe.event.special[f]||{},i||!p.trigger||!1!==p.trigger.apply(n,r))){if(!i&&!p.noBubble&&!we(n)){for(u=p.delegateType||f,Pt.test(u+f)||(a=a.parentNode);a;a=a.parentNode)d.push(a),s=a
s===(n.ownerDocument||ue)&&d.push(s.defaultView||s.parentWindow||e)}for(o=0;(a=d[o++])&&!t.isPropagationStopped();)h=a,t.type=o>1?u:p.bindType||f,c=(Ue.get(a,"events")||{})[t.type]&&Ue.get(a,"handle"),c&&c.apply(a,r),(c=l&&a[l])&&c.apply&&qe(a)&&(t.result=c.apply(a,r),!1===t.result&&t.preventDefault())
return t.type=f,i||t.isDefaultPrevented()||p._default&&!1!==p._default.apply(d.pop(),r)||!qe(n)||l&&_e(n[f])&&!we(n)&&(s=n[l],s&&(n[l]=null),xe.event.triggered=f,t.isPropagationStopped()&&h.addEventListener(f,jt),n[f](),t.isPropagationStopped()&&h.removeEventListener(f,jt),xe.event.triggered=void 0,s&&(n[l]=s)),t.result}},simulate:function(e,t,r){var n=xe.extend(new xe.Event,r,{type:e,isSimulated:!0})
...
xe.event.special[t]={setup:function(){var n=this.ownerDocument||this,i=Ue.access(n,t)
i||n.addEventListener(e,r,!0),Ue.access(n,t,(i||0)+1)},teardown:function(){var n=this.ownerDocument||this,i=Ue.access(n,t)-1
i?Ue.access(n,t,i):(n.removeEventListener(e,r,!0),Ue.remove(n,t))}}})
var Mt=e.location,Nt=Date.now(),Dt=/\?/
...
c||(c=!0,u&&e.clearTimeout(u),i=void 0,a=s||"",x.readyState=t>0?4:0,l=t>=200&&t<300||304===t,n&&(_=oe(f,x,n)),_=ae(f,_,x,l),l?(f.ifModified&&(w=x.getResponseHeader("Last-Modified"),w&&(xe.lastModified[o]=w),(w=x.getResponseHeader("etag"))&&(xe.etag[o]=w)),204===t||"HEAD"===f.type?E="nocontent":304===t?E="notmodified":(E=_.state,h=_.data,d=_.error,l=!d)):(d=E,!t&&E||(E="error",t<0&&(t=0))),x.status=t,x.statusText=(r||E)+"",l?g.resolveWith(m,[h,E,x]):g.rejectWith(m,[x,E,d]),x.statusCode(b),b=void 0,p&&y.trigger(l?"ajaxSuccess":"ajaxError",[x,f,l?h:d]),v.fireWith(m,[x,E]),p&&(y.trigger("ajaxComplete",[x,f]),--xe.active||xe.event.trigger("ajaxStop")))}"object"==typeof t&&(r=t,t=void 0),r=r||{}
var i,o,a,s,u,l,c,p,h,d,f=xe.ajaxSetup({},r),m=f.context||f,y=f.context&&(m.nodeType||m.jquery)?xe(m):xe.event,g=xe.Deferred(),v=xe.Callbacks("once memory"),b=f.statusCode||{},_={},w={},E="canceled",x={readyState:0,getResponseHeader:function(e){var t
if(c){if(!s)for(s={};t=Bt.exec(a);)s[t[1].toLowerCase()+" "]=(s[t[1].toLowerCase()+" "]||[]).concat(t[2])
t=s[e.toLowerCase()+" "]}return null==t?null:t.join(", ")},getAllResponseHeaders:function(){return c?a:null},setRequestHeader:function(e,t){return null==c&&(e=w[e.toLowerCase()]=w[e.toLowerCase()]||e,_[e]=t),this},overrideMimeType:function(e){return null==c&&(f.mimeType=e),this},statusCode:function(e){var t
if(e)if(c)x.always(e[x.status])
else for(t in e)b[t]=[b[t],e[t]]
return this},abort:function(e){var t=e||E
return i&&i.abort(t),n(0,t),this}}
if(g.promise(x),f.url=((t||f.url||Mt.href)+"").replace(Kt,Mt.protocol+"//"),f.type=r.method||r.type||f.method||f.type,f.dataTypes=(f.dataType||"*").toLowerCase().match(Ne)||[""],null==f.crossDomain){l=ue.createElement("a")
...
p=xe.event&&f.global,p&&0==xe.active++&&xe.event.trigger("ajaxStart"),f.type=f.type.toUpperCase(),f.hasContent=!Wt.test(f.type),o=f.url.replace(Ut,""),f.hasContent?f.data&&f.processData&&0===(f.contentType||"").indexOf("application/x-www-form-urlencoded")&&(f.data=f.data.replace(qt,"+")):(d=f.url.slice(o.length),f.data&&(f.processData||"string"==typeof f.data)&&(o+=(Dt.test(o)?"&":"?")+f.data,delete f.data),!1===f.cache&&(o=o.replace(Ht,"$1"),d=(Dt.test(o)?"&":"?")+"_="+Nt+++d),f.url=o+d),f.ifModified&&(xe.lastModified[o]&&x.setRequestHeader("If-Modified-Since",xe.lastModified[o]),xe.etag[o]&&x.setRequestHeader("If-None-Match",xe.etag[o])),(f.data&&f.hasContent&&!1!==f.contentType||r.contentType)&&x.setRequestHeader("Content-Type",f.contentType),x.setRequestHeader("Accept",f.dataTypes[0]&&f.accepts[f.dataTypes[0]]?f.accepts[f.dataTypes[0]]+("*"!==f.dataTypes[0]?", "+Qt+"; q=0.01":""):f.accepts["*"])
for(h in f.headers)x.setRequestHeader(h,f.headers[h])
if(f.beforeSend&&(!1===f.beforeSend.call(m,x,f)||c))return x.abort()
if(E="abort",v.add(f.complete),x.done(f.success),x.fail(f.error),i=ne(Gt,f,r,x)){if(x.readyState=1,p&&y.trigger("ajaxSend",[x,f]),c)return x
...
var Zt=[],er=/(=)\?(?=&|$)|\?\?/
xe.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=Zt.pop()||xe.expando+"_"+Nt++
...
return s>-1&&(n=X(e.slice(s)),e=e.slice(0,s)),_e(t)?(r=t,t=void 0):t&&"object"==typeof t&&(i="POST"),a.length>0&&xe.ajax({url:e,type:i||"GET",dataType:"html",data:t}).done(function(e){o=arguments,a.html(n?xe("<div>").append(xe.parseHTML(e)).find(n):e)}).always(r&&function(e,t){a.each(function(){r.apply(this,o||[e.responseText,t,e])})}),this},xe.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){xe.fn[t]=function(e){return this.on(t,e)}}),xe.expr.pseudos.animated=function(e){return xe.grep(xe.timers,function(t){return e===t.elem}).length},xe.offset={setOffset:function(e,t,r){var n,i,o,a,s,u,l,c=xe.css(e,"position"),p=xe(e),h={}
"static"===c&&(e.style.position="relative"),s=p.offset(),o=xe.css(e,"top"),u=xe.css(e,"left"),l=("absolute"===c||"fixed"===c)&&(o+u).indexOf("auto")>-1,l?(n=p.position(),a=n.top,i=n.left):(a=parseFloat(o)||0,i=parseFloat(u)||0),_e(t)&&(t=t.call(e,r,xe.extend({},s))),null!=t.top&&(h.top=t.top-s.top+a),null!=t.left&&(h.left=t.left-s.left+i),"using"in t?t.using.call(e,h):p.css(h)}},xe.fn.extend({offset:function(e){if(arguments.length)return void 0===e?this:this.each(function(t){xe.offset.setOffset(this,e,t)})
var t,r,n=this[0]
...
return xe.noConflict=function(t){return e.$===xe&&(e.$=rr),t&&e.jQuery===xe&&(e.jQuery=tr),xe},t||(e.jQuery=e.$=xe),xe}),function(){var e,t,r,n=this;(function(){function n(e,t){throw t?new Error("Could not find module "+e+" required by: "+t):new Error("Could not find module "+e)}function i(e,r){var s=e,u=o[s]
u||(s+="/index",u=o[s])
var l=a[s]
...
n!==v&&i.push(n)}return s(i)},e.CachedTag=x,e.UpdatableTag=A,e.CachedReference=S,e.map=function(e,t){return new T(e,t)},e.ReferenceCache=k,e.isModified=function(e){return e!==P}}),e("@glimmer/runtime",["exports","@glimmer/util","@glimmer/reference","@glimmer/wire-format"],function(e,t,r,n){"use strict"
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):I(e,t))}function z(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function q(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function U(e){return"object"==typeof e&&null!==e&&e[Or]}function H(e,t){var r,n,i,o=Object.getOwnPropertyNames(t)
for(r=0;r<o.length;r++)n=o[r],(i=Object.getOwnPropertyDescriptor(t,n))&&i.configurable&&void 0===e[n]&&Object.defineProperty(e,n,i)
...
a.newBounds(u),o&&e.updateWith(this.updateWith(e,t,o,u,s))},e}(),jr=function(e){function t(){return ee(this,t),X(this,e.apply(this,arguments))}return Z(t,e),t.create=function(e){return new t(e)},t.prototype.toBool=function(e){return U(e)},t}(Ht),Mr=function(e){function t(r,n,i){ee(this,t)
var o=X(this,e.call(this))
...
if(s.startLabels(),o?(s.fetch(kt.s1),be(o,s),s.dup(),s.load(kt.s1),s.test("simple"),s.jumpUnless("BODY"),s.fetch(kt.s1),s.pushComponentOperations(),s.openDynamicElement()):a&&(s.pushComponentOperations(),s.openElementWithOperations(a)),o||a){for(s.didCreateElement(kt.s0),e=this.attrs.buffer,t=0;t<e.length;t++)Ee(e[t],s)
...
return r},e.ensureGuid=n,e.initializeGuid=r,e.Stack=x,e.DictSet=E,e.dict=a,e.EMPTY_SLICE=A,e.LinkedList=R,e.ListNode=function e(t){s(this,e),this.next=null,this.prev=null,this.value=t},e.ListSlice=O,e.A=k,e.EMPTY_ARRAY=P,e.HAS_NATIVE_WEAKMAP=C,e.unwrap=function(e){if(null===e||void 0===e)throw new Error("Expected value to be present")
...
null!==a&&"object"==typeof a&&a.isDescriptor&&a.willChange&&a.willChange(t,r),o&&(R(t,r,i),C(t,r,i),M(t,r,i))}}function x(t,r,n){var i=n||e.peekMeta(t),o=!!i
...
n&&n.revalidate(t)}function k(){Rt++}function P(){--Rt<=0&&(Et.clear(),xt.flush())}function j(e,t){k()
...
var u=void 0
return r instanceof D?(u=r,e[t]=u,F(e.constructor),"function"==typeof r.setup&&r.setup(e,t)):void 0===r||null===r?(u=n,e[t]=n):(u=r,Object.defineProperty(e,t,r)),a&&T(e,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,u),this}function F(e){if(!1!==Ct){var t=X(e).readableCache()
...
1===s?(a.writeWatching(r,0),i=t[r],o=null!==i&&"object"==typeof i&&i.isDescriptor,o&&i.didUnwatch&&i.didUnwatch(t,r),"function"==typeof t.didUnwatchProperty&&t.didUnwatchProperty(r)):s>1&&a.writeWatching(r,s-1)}}}function q(e,t){return(t||X(e)).writableChains(U)}function U(e){return new kt(null,null,e)}function H(e,t,r){if("object"==typeof e&&null!==e){var n=r||X(e),i=n.peekWatching(t)||0
...
return Ft(t,i),i}function Z(e){return Ht.get(e)}function ee(e){return-1!==Bt.get(e)}function te(e){return Vt.get(e)}function re(e){return Wt.get(e)}function ne(e,t){var r=e[t]
...
return r&&r.watchedEvents()||[]},e.isNone=Ae,e.isEmpty=Ce,e.isBlank=Se,e.isPresent=function(e){return!Se(e)},e.run=Te,e.ObserverSet=_t,e.beginPropertyChanges=k,e.changeProperties=j,e.endPropertyChanges=P,e.overrideChains=T,e.propertyDidChange=x,e.propertyWillChange=E,e.PROPERTY_DID_CHANGE=wt,e.defineProperty=I,e.Descriptor=D,e._hasCachedComputedProperties=function(){Ct=!0},e.watchKey=L,e.unwatchKey=z,e.ChainNode=kt,e.finishChains=function(e){var t=e.readableChainWatchers()
...
for(r=0;r<n.length;r++)i=n[r],ae(e,i,t[i])}),t):t},e.expandProperties=le,e._suspendObserver=He,e._suspendObservers=function(e,t,r,n,i){return m(e,t.map(Fe),r,n,i)},e.addObserver=ze,e.observersFor=function(e,t){return g(e,Fe(t))},e.removeObserver=qe,e._addBeforeObserver=Ue,e._removeBeforeObserver=Be,e.Mixin=hr,e.aliasMethod=function(e){return new ut(e)},e._immediateObserver=function(){var e
...
return i&&"replace"===i.urlMethod&&c.method(i.urlMethod),c},replaceWith:function(){return I(this,arguments).method("replace")},generate:function(e){var t,r,n,a,s=o(B.call(arguments,1)),u=s[0],l=s[1],c=new Y({name:e,contexts:u}),p=c.applyToState(this.state,this.recognizer,this.getHandler,null,this.getSerializer),h={}
...
!n&&i&&(n=!0,x(e,i))},e)}function v(e,t){t._state===ve?E(e,t._result):t._state===be?(t._onError=null,x(e,t._result)):R(t,void 0,function(r){t!==r?_(e,r,void 0):E(e,r)},function(t){return x(e,t)})}function b(e,t,r){t.constructor===e.constructor&&r===k&&e.constructor.resolve===h?v(e,t):r===_e?(x(e,_e.error),_e.error=null):s(r)?g(e,t,r):E(e,t)}function _(e,t){e===t?E(e,t):a(t)?b(e,t,m(t)):E(e,t)}function w(e){e._onError&&e._onError(e._result),O(e)}function E(e,t){e._state===ge&&(e._result=t,e._state=ve,0===e._subscribers.length?he.instrument&&p("fulfilled",e):he.async(O,e))}function x(e,t){e._state===ge&&(e._state=be,e._result=t,he.async(w,e))}function R(e,t,r,n){var i=e._subscribers,o=i.length
...
return s[a]=function(e,t){e?x(l,e):void 0===r?_(l,t):!0===r?_(l,L(arguments)):fe(r)?_(l,F(arguments,r)):_(l,t)},u?H(l,s,e,o):U(l,s,e,o)}
return(0,t.defaults)(n,e),n}function U(e,t,r,n){var i=I(r,n,t)
return i===Ae&&x(e,i.value),e}function H(e,t,r,n){return Oe.all(t).then(function(t){var i=I(r,n,t)
...
this._remaining=o
var a=void 0
for(t=0;r._state===ge&&t<o;t++)a=n[t],this._eachEntry(a.entry,a.position)},r}(Ee),Pe=function(e){function r(r,n,i){return(0,t.possibleConstructorReturn)(this,e.call(this,r,n,!1,i))}return(0,t.inherits)(r,e),r}(ke)
...
return u=Yt.resolve(u,l),u=A(u,O(C,t)),u.then(function(i){var o=B(t,e,s),a=H(o,t,r,i,n,"findRecord")
...
return s=Yt.resolve(s,u),s=A(s,O(C,t)),s.then(function(n){var i=B(t,e,r),o=H(i,t,a,n,null,"findMany")
...
return s=Yt.resolve(s,u),s=A(s,O(C,t)),s=A(s,O(C,r)),s.then(function(r){var n=B(t,e,i.type),o=H(n,t,a,r,null,"findHasMany"),s=t._push(o)
...
return s=Yt.resolve(s,u),s=A(s,O(C,t)),s=A(s,O(C,r)),s.then(function(r){var n=B(t,e,i.type),o=H(n,t,a,r,null,"findBelongsTo")
...
return u=Yt.resolve(u,l),u=A(u,O(C,t)),u.then(function(n){var i=B(t,e,r),s=H(i,t,o,n,null,"findAll")
...
return a=Yt.resolve(a,s),a=A(a,O(C,t)),a.then(function(a){var s=B(t,e,r),u=H(s,t,o,a,null,"query"),l=t._push(u)
...
return o=Yt.resolve(o,a),o=A(o,O(C,t)),o.then(function(n){var o=B(t,e,r),a=H(o,t,i,n,null,"queryRecord")
...
return s=Cr.resolve(s,l),s=A(s,O(C,t)),s=A(s,O(C,i)),s.then(function(e){return t._backburner.join(function(){var o=void 0,s=void 0
...
return r.clear(),r.addInternalModels(t.map(function(e){return Pr(e,"_internalModel")})),r.getRecords()}}).meta(r)}function he(e){var t=Object.create(null)
if(!e)return t
...
return r.set(e,t,p),p}var h=s.name,d=$t(s.type,"relationshipsByName").get(h),f=d.type,m=f===c
if(i=r.get(f,t)||r.get(c,h)){Gt("The "+c+":"+h+" relationship declares 'inverse: null', but it was resolved as the inverse for "+f+":"+t+".",!1!==i.hasInverse)
...
return e._query(this.modelName,t,this)},_setInternalModels:function(e,t){this.get("content").setObjects(e),this.setProperties({isLoaded:!0,isUpdating:!1,meta:X(t.meta),links:X(t.links)}),ie(e,this),Ember.run.once(this,"trigger","didLoad")}}),ur=Ember.get,lr=Ember.set,cr=Ember.run,pr=function(){function e(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._filteredRecordArrays=Object.create(null),this._liveRecordArrays=Object.create(null),this._pending=Object.create(null),this._adapterPopulatedRecordArrays=[]}return e.prototype.recordDidChange=function(e){this.internalModelDidChange(e)},e.prototype.recordWasLoaded=function(e){this.internalModelDidChange(e)},e.prototype.internalModelDidChange=function(e){var t=e.modelName
...
return i&&(r[t]=i,hr(i,"store",this._store)),r[t]},e.prototype._fallbacksFor=function(e,t){return"adapter"===e?["application",this._store.get("adapter"),"-json-api"]:["application",this.get("adapter",t).get("defaultSerializer"),"-default"]},e.prototype._findInstance=function(e,t){for(var r=this._namespaces[e],n=0,i=t.length;n<i;n++){var o=t[n]
if(r[o])return r[o]
...
o&&o.destroy()}},e.prototype.destroy=function(){this.isDestroying=!0,this.destroyCache(this._namespaces.adapter),this.destroyCache(this._namespaces.serializer),this.isDestroyed=!0},e.prototype.toString=function(){return"ContainerInstanceCache"},e}(),fr=Ember.A,mr=Ember._Backburner,yr=Ember.computed,gr=Ember.copy,vr=Ember.ENV,br=Ember.Error,_r=Ember.get,wr=(Ember.inspect,Ember.isNone),Er=(Ember.isPresent,Ember.MapWithDefault),xr=Ember.run,Rr=Ember.set,Or=Ember.RSVP,Ar=Ember.Service,Cr=(Ember.typeOf,Or.Promise),Sr=void 0
Sr=Ar.extend({init:function(){this._super.apply(this,arguments),this._backburner=new mr(["normalizeRelationships","syncRelationships","finished"]),this.recordArrayManager=new pr({store:this}),this._identityMap=new Bt,this._pendingSave=[],this._instanceCache=new dr(F(this),this),this._modelFactoryCache=Object.create(null),this._relationshipsPayloads=new Qt(this),this._pendingSave=[],this._updatedRelationships=[],this._pushedInternalModels=[],this._updatedInternalModels=[],this._pendingFetch=Er.create({defaultValue:function(){return[]}}),this._instanceCache=new dr(F(this),this)},adapter:"-json-api",serialize:function(e,t){return a("ds-deprecate-store-serialize"),e._internalModel.createSnapshot().serialize(t)},defaultAdapter:yr("adapter",function(){var e=_r(this,"adapter")
return this.adapterFor(e)}),createRecord:function(e,t){var r=f(e),n=gr(t)||Object.create(null)
...
return i(Or.all(r).then(fr,null,"DS: Store#findByIds of "+n+" complete"))},_fetchRecord:function(e,t){var r=e.modelName,n=this.adapterFor(r)
...
var r=e.id,n=e.modelName,i=Or.defer("Fetching "+n+"' with id: "+r),o={internalModel:e,resolver:i,options:t},a=i.promise
...
return n.shouldReloadAll(this,a)?(Rr(t,"isUpdating",!0),i(G(n,this,e,o,r))):!1===r.backgroundReload?i(Cr.resolve(t)):((r.backgroundReload||n.shouldBackgroundReloadAll(this,a))&&(Rr(t,"isUpdating",!0),G(n,this,e,o,r)),i(Cr.resolve(t)))},_didUpdateAll:function(e){this.recordArrayManager._didUpdateAll(e)},didUpdateAll:function(e){return this._didUpdateAll(e)},peekAll:function(e){var t=f(e)
...
return r}}})
var Tr=Sr,kr=Ember.Namespace.create({VERSION:r,name:"DS"})
Ember.libraries&&Ember.libraries.registerCoreLibrary("Ember Data",kr.VERSION)
var Pr=Ember.get,jr=Ember.get,Mr=Ember.Mixin.create({buildURL:function(e,t,r,n,i){switch(n){case"findRecord":return this.urlForFindRecord(t,e,r)
...
return Ember.String.pluralize(t)}}),Nr="\r\n",Dr=de(function(e){return e&&void 0===e.nodeType?e:void 0}("object"==typeof global&&global))||de("object"==typeof self&&self)||de("object"==typeof window&&window)||new Function("return this")(),Ir=Ember.String.capitalize,Fr=Ember.String.underscore,Lr=Ember.assert,zr=Ember.get,qr=Ember.DataAdapter.extend({getFilters:function(){return[{name:"isNew",desc:"New"},{name:"isModified",desc:"Modified"},{name:"isClean",desc:"Clean"}]},detect:function(e){return e!==ze&&ze.detect(e)},columnsForType:function(e){var t=[{name:"id",desc:"Id"}],r=0,n=this
...
e.Model=ze,e.Errors=Re,e.Store=Tr,e.DS=kr,e.belongsTo=ce,e.hasMany=pe,e.BuildURLMixin=Mr,e.Snapshot=ft,e.AdapterError=v,e.InvalidError=Ve,e.UnauthorizedError=$e,e.ForbiddenError=Ge,e.NotFoundError=Qe,e.ConflictError=Ye,e.ServerError=Je,e.TimeoutError=We,e.AbortError=Ke,e.errorsHashToArray=w,e.errorsArrayToHash=E,e.normalizeModelName=f,e.getOwner=F,e.modelHasAttributeOrRelationshipNamedType=I,e.coerceId=J,e.parseResponseHeaders=he,e.global=Dr,e.isEnabled=a,e.RootState=Te,e.InternalModel=qt,e.ContainerInstanceCache=dr,e.PromiseArray=ye
e.PromiseObject=ge,e.PromiseManyArray=ve,e.RecordArray=nr,e.FilteredRecordArray=or,e.AdapterPopulatedRecordArray=sr,e.ManyArray=ot,e.RecordArrayManager=pr,e.Relationship=rt,e.DebugAdapter=qr,e.diffArray=S,e.RelationshipPayloadsManager=Qt,e.RelationshipPayloads=Kt,e.SnapshotRecordArray=Xt,Object.defineProperty(e,"__esModule",{value:!0})}),define("ember-data/adapter",["exports"],function(e){"use strict"
